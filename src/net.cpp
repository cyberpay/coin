...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "antilitecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"tekyboy.tk", "192.52.166.80"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"antilitecointools.com", "testnet-seed.antilitecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. antilitecoin is probably already running."), addrBind.ToString().c_str());
        else
